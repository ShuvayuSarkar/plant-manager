...
export default function JoinWaitlist() {
    ...
    return (
        <div className="flex flex-col gap-5 px-6 sm:px-12 lg:px-40 py-20 items-center justify-center text-lg sm:text-xl lg:text-2xl leading-8 sm:leading-9 lg:leading-10 text-center">
            <p>
