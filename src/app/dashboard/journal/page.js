...
export default function Journal() {
    ...
    if (loading) {
        return <div role="status" className='flex h-full w-full text-[16px] justify-center items-center'>
            <svg aria-hidden="true" className="w-8 h-8 text-neutral-200 animate-spin dark:text-neutral-600 fill-neutral-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <div className='flex h-full w-full text-[16px]'>
